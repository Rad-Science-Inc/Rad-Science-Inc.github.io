...
export default function CtaBanner() {
  ...
  return (
    <section className="relative py-28 lg:py-36 overflow-hidden bg-gray-950">
      <div className="absolute inset-0 bg-gradient-to-br from-blue-950 via-gray-950 to-violet-950" />
      <div
      ...
      />
      <div
        className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-600 rounded-full blur-[160px] opacity-20 pointer-events-none animate-blob"
        style={{ animationDuration: "20s" }}
      />
      <div
        className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-violet-600 rounded-full blur-[140px] opacity-20 pointer-events-none animate-blob"

...
export const dictionaries = {
  ko: {
    ...
    pageHeaders: {
      ...
      about: {
        badge: "About Us",
        title: "의료데이터와 컴퓨터과학을 융합해 새로운 가능성을 설계합니다",
        subtitle: "의료연구와 컴퓨터과학의 융합에서 출발한 의료 데이터 연구 전문 법인",
        breadcrumb: "회사 소개",
      },
      services: {
        badge: "Services",
    ...
    about: {
      ...
      paragraph1:
        "Rad Science는 의학연구와 데이터 과학(Data Science)의 융합에서 출발한 의료 AI 전문 기업입니다.",
      paragraph2:
        "국내 주요 대학병원 및 연구기관과의 협력을 통해 쌓은 의료 도메인 지식과 최신 딥러닝 기술을 융합하여, 연구자들이 더 빠르고 정확하게 임상적 인사이트를 얻을 수 있도록 지원합니다.",
      leadership: {
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "연구 기관 및 병원의 데이터 수집·전처리·분석까지 전 과정의 파이프라인을 설계하고 구축합니다. 반복 연구 작업의 효율을 획기적으로 개선합니다.",
          details: [
            "데이터 수집 및 전처리 자동화",
        ...
        {
          title: "연구 컨설팅 & 공동 연구",
          desc: "의료 AI 설계부터 논문 작성까지 전 과정을 함께합니다. 국내외 학술지 게재 경험을 바탕으로 데이터분석 결과와 논문 작성 지원을 제공합니다.",
          details: [
    ...
    whyUs: {
      ...
      differentiators: [
        ...
        {
          title: "End-to-End 지원",
          desc: "데이터 수집, 설계부터 AI 모델 개발, 논문 작성까지 연구의 전 과정을 하나의 팀이 담당합니다.",
        },
        {
          title: "신속한 프로토타이핑",
    ...
    ctaBanner: {
      ...
      subtitle:
        "연구 설계, 데이터 분석, 소프트웨어 도입 — 어느 단계든 지금 바로 이야기해 보세요. 상담은 무료입니다.",
  ...
  en: {
    ...
    about: {
      ...
      orgChart: {
        members: [
          { name: "Seongho Cho", role: "Executive Director", bio: "Leads research advisory and project concept design, setting overall direction" },
